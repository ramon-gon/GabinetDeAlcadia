...
To start the application, use the **GabinetDeAlcadia Jmix Application** run configuration in your IDE, or run the following command in the project root directory:
